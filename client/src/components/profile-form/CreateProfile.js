    ...
    <Fragment>
      ...
      <form className="form" onSubmit={e => onSubmit(e)}>
        ...
        <div className="form-group social-input">
          ...
          <input type="text" placeholder="YouTube URL" onChange={e => onChange(e)} value={youtube} name="youtube" />
        </div>

        <div className="form-group social-input">
          <i className="fab fa-linkedin fa-2x"></i>
          <input type="text" placeholder="Linkedin URL" onChange={e => onChange(e)} value={linkedin} name="linkedin" />
        </div>

        <div className="form-group social-input">
          <i className="fab fa-instagram fa-2x"></i>
          <input type="text" placeholder="Instagram URL" onChange={e => onChange(e)} value={instagram} name="instagram" />
        </div>
        </Fragment>
        )}
